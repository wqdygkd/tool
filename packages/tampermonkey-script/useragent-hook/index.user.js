...
(function () {
  ...
  console.dir(originFetch);
  window.unsafeWindow.fetch = (url, options) => {
    console.log(options);
    options.headers['User-Agent'] = 'Mozill/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Safari/537.36';
