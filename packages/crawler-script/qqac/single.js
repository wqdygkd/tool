...
const extractLastPageNumber = async page => {
  const lastPageNumber = await page.evaluate(() => {
    const content = [...document.querySelectorAll('.article-content>.article-paging .post-page-numbers')]
    content.pop()
...
const extractNextPage = async page => {
  const nextPage = await page.evaluate(() => {
    return [...document.querySelectorAll('.post-page-numbers')].pop().getAttribute('href')
  })
